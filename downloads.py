    ...
    try:
        ...
        try:
            ...
            try:
                ...
                out = "Warning: LatAmSEF {0} no se encuentra disponible".format(str(fecha))
    print(out)
...
def gfi_dl(fecha):
    ...
    try:
        ...
        out = "Warning: GFI {0} no se encuentra disponible".format(str(fecha_x))
    print(out)
...
def bgc_dl(fecha):
    ...
    try:
        ...
        out = "Warning: BGC {0} no se encuentra disponible".format(str(fecha_x))
    print(out)
